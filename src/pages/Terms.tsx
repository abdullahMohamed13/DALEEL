...
export default function Terms() {
  return (
    <motion.div
      ...
      className="container mx-auto px-6 py-12 mt-8 max-w-4xl"
    >
      <motion.div
        className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl shadow-primary/5 border border-primary/10 relative overflow-hidden"
      >
        ...
        <div className="space-y-8 text-muted-foreground leading-relaxed relative z-10">
          <motion.section
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.2 }}
          >
            <h2 className="text-2xl font-bold text-foreground mb-4">قبول الشروط</h2>
            <p>
          ...
          >
            <h2 className="text-2xl font-bold text-foreground mb-4">إخلاء المسؤولية للمستندات</h2>
            <p>
          ...
          >
            <h2 className="text-2xl font-bold text-foreground mb-4">سلوك المجتمع التفاعلي</h2>
            <p>
