  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-white rounded-3xl p-8 md:p-12 shadow-[0_25px_50px_-12px_hsl(var(--primary)_/_0.1)] border border-[#0000000D]"
      >
        ...
        <div className="space-y-8 text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">2. استخدام البيانات</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">3. حماية بياناتك ومستنداتك</h2>
            <p>
